...
impl Cert {
    ...
    pub fn html(&self) -> String {
        ...
        for (k, v) in [
            ...
            ("Capacity", format!("{} ({} bytes)", human(self.size), self.size)),
        ...
        for (k, v) in [
            ...
            ("NIST 800-88", format!("{} (Rev. 1)", standard(&self.method))),
        ...
        h.push_str(". This is a record of what the tool observed on the host named above. \
...
mod tests {
    ...
    fn sample(passed: bool) -> Cert {
        Cert {
            ...
            had_data: true,
            points: vec![
                Point { at: 0, before: "eb52904e54465320".into(), after: "0".repeat(16), ok: true },
                Point { at: 4096, before: "ff".repeat(8), after: "ff".repeat(8), ok: passed },
            ],
            passed,
